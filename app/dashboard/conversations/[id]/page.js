...
=======
          ...
          {/* ── Typing indicator ─────────────────────────────────────────────
              ...
              (bg-black / dark:bg-white, rounded-tr-sm) so it feels native.
              Three dots animate with staggered delays to create the wave effect.
          ─────────────────────────────────────────────────────────────────── */}
          {isTyping && (
            <div className="flex w-full justify-end">
              <div className="bg-black dark:bg-white rounded-2xl rounded-tr-sm px-4 py-3 shadow-sm">
                <div className="flex items-center gap-[5px]">
                  <span
                    className="w-[7px] h-[7px] rounded-full bg-white dark:bg-black"
