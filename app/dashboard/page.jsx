    ...
    <div className="flex-1 p-8 bg-gray-50 dark:bg-[#0a0a0a] min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
        {stats.map(({ label, value, change, icon: Icon }) => (
          <div
            key={label}
            className="bg-white dark:bg-[#111] border border-gray-200 dark:border-gray-800 rounded-2xl p-5 flex flex-col gap-4"
          >
      ...
      <div className="bg-white dark:bg-[#111] border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <a
            ...
            className="flex items-center gap-3 p-4 rounded-xl border border-gray-100 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-white/5 transition-all duration-200 group"
          >
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">View Conversations</p>
              <p className="text-xs text-gray-400 dark:text-gray-500">See all AI-managed chats</p>
            </div>
          </a>
          <a
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">WhatsApp Settings</p>
              <p className="text-xs text-gray-400 dark:text-gray-500">Configure your AI agent</p>
            </div>
          </a>
        </div>
      </div> */}
