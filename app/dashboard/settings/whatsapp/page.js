        ...
        {!loading && step === "list" && (
          <>
            {avaiableWorkspace.length === 0 ? (
              <div className="text-center py-20 bg-white dark:bg-[#111] border border-gray-200 dark:border-gray-800 rounded-2xl">
                <div className="w-12 h-12 rounded-2xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center mx-auto mb-4">
                  <span className="text-xl">📱</span>
                </div>
                <p className="font-semibold text-gray-700 dark:text-gray-300">No workspaces yet</p>
                <p className="text-sm text-gray-400 dark:text-gray-500 mt-1 mb-5">
                  Create your first workspace to get started.
                </p>
                <button
                  onClick={() => router.push("/workspace/create")}
                  className="h-10 px-5 bg-black dark:bg-white text-white dark:text-black rounded-xl text-sm font-semibold hover:bg-gray-800 dark:hover:bg-gray-100 transition-all"
                >
                  Create Workspace
                </button>
              </div>
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      {ws.whatsapp_access_token && (
                        <span className="text-[10px] font-semibold text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-950/40 px-2 py-0.5 rounded-full shrink-0">
                          ✓ Configured
                        </span>
                      )}
                    </div>
              ...
              <div key={field}>
                ...
                <div className="relative">
                  <input
                    ...
                    readOnly={isViewMode}
                    className={`w-full h-11 px-4 ${isPassword ? "pr-11" : "pr-4"} rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#0a0a0a] text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 font-mono text-sm focus:outline-none transition-all
                      ${isViewMode
          ...
          <div className="flex gap-3 pt-2">
            ...
            {hasToken && !isEditing && (
              <button
                ...
                className="h-11 px-6 bg-black dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-100 text-white dark:text-black rounded-xl text-sm font-semibold transition-all duration-200 active:scale-[0.98]"
              >
                Edit Configuration
              </button>
            )}
